...
function showMenu() {
 ...
 function showL() {
    document.getElementById("menuList").innerHTML = '<div class="card-body"><center><ul><li><a onclick=" updateLFile()">Render</a></li><li><a onclick=" saveFile()">Download</a></li></ul></center></div>'
